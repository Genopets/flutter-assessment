// Ripped from https://github.com/florent37/Flutter-KenBurns/

import 'dart:developer';

import 'package:flutter/material.dart';
import 'package:flutter_inventory/app/widgets/atoms/kenburns/kenburns_generator.dart';
...
class _KenBurnsState extends State<KenBurns> with TickerProviderStateMixin {
  ...
  Future<void> _createNextAnimations(
    ...
    final nextConfig = _kenburnsGenerator.generateNextConfig(
        width: width,
        height: height,
  ...
  Future<void> fire({required double height, required double width}) async {
    _running = true;
  ...
  void initState() {
    ...
    final dur = _kenburnsGenerator.generateNextDuration(
