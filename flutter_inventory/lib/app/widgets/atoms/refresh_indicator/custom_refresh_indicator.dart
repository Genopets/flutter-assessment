...
import 'package:flutter_inventory/app/widgets/atoms/refresh_indicator/custom_refresh_progress_indicator.dart';
...
class CustomRefreshIndicatorState extends State<CustomRefreshIndicator>
  ...
  void didChangeDependencies() {
    ...
    _valueColor = _positionController.drive(
      ColorTween(
        begin: (widget.color ?? theme.colorScheme.primary).withOpacity(0),
        end: (widget.color ?? theme.colorScheme.primary).withOpacity(1),
      ).chain(CurveTween(
                ...
                child: ScaleTransition(
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (BuildContext context, Widget? child) {
                      return const CustomRefreshProgressIndicator(
                        size: 100,
                      );
                    },
                  ),
